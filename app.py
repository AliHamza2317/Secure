...
download_google_drive_folder(
    "https://drive.google.com/drive/folders/10WjSqu1-eAZHjtz_8qG3GhT84pD0HuD2?usp=sharing", 
    "sentimentmodel"
)
download_google_drive_folder(
    "https://drive.google.com/drive/folders/1J4kwZ_MoxAvbsBaSe8r3h1Xx_8jejpm3?usp=sharing", 
    "issue-model"
)
download_google_drive_folder(
    "https://drive.google.com/drive/folders/1r-T5XkA84hS_dTJx2FzP8XmVC92wiYLD?usp=sharing", 
    "subcategorymodel"
)
...
sentiment_model = BertForSequenceClassification.from_pretrained("sentimentmodel").to(device)
sentiment_tokenizer = BertTokenizer.from_pretrained("sentimentmodel")

issue_model = BertForSequenceClassification.from_pretrained("issue-model").to(device)
issue_tokenizer = BertTokenizer.from_pretrained("issue-model")

subcategory_model = BertForSequenceClassification.from_pretrained("subcategorymodel").to(device)
subcategory_tokenizer = BertTokenizer.from_pretrained("subcategorymodel")
